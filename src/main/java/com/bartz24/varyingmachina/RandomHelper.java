...
public class RandomHelper {
	public static float roundNumberUp(float num, float decimalPlaces) {
		return (float) (Math.ceil(num * (10f * decimalPlaces)) / (10f * decimalPlaces));
	}

	public static float roundNumberDown(float num, float decimalPlaces) {
		return (float) (Math.floor(num * (10f * decimalPlaces)) / (10f * decimalPlaces));
	}
