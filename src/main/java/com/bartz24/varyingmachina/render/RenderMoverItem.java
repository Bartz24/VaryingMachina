...
@OnlyIn(Dist.CLIENT)
public class RenderMoverItem extends EntityRenderer<EntityMoverItem> {
    private final ItemRenderer itemRenderer;
    private final Random random = new Random();

    public RenderMoverItem(EntityRendererManager renderManagerIn) {
    ...
    private int transformModelCount(EntityMoverItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
     ...
     */
    public void doRender(EntityMoverItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        y -= 0.25;
     ...
     */
    protected ResourceLocation getEntityTexture(EntityMoverItem entity) {
