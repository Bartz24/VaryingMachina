...
public class VMItemPickaxe extends PickaxeItem implements IVariantItem, IMaterialItem {
    ...
    public ITextComponent getDisplayName(ItemStack stack) {
        return new TranslationTextComponent("itemtype.pickaxe", material.getTranslationKey());
    }
}
